...
export async function seedServiceNowData(dataSource: DataSource, tenantId: number): Promise<void> {
  ...
  const incidentsData = [
    {
      ...
      callerName: 'Jane Doe',
      openedAt: shiftDate('2026-01-18 07:15:00'),
      resolvedAt: shiftDate('2026-01-18 10:30:00'),
      closedAt: shiftDate('2026-01-18 11:00:00'),
      resolutionCode: 'Service Restored',
      resolutionNotes: 'Exchange server restarted. Root cause: memory leak.',
      sysCreatedOn: shiftDate('2026-01-18 07:15:00'),
      sysUpdatedOn: shiftDate('2026-01-18 11:00:00'),
      sysCreatedBy: 'system',
    ...
    },
    {
      ...
      openedAt: shiftDate('2026-01-25 13:45:00'),
      resolvedAt: shiftDate('2026-01-25 16:20:00'),
      closedAt: shiftDate('2026-01-25 16:45:00'),
      resolutionCode: 'Configuration Change',
      resolutionNotes: 'API rate limit increased with Salesforce.',
      sysCreatedOn: shiftDate('2026-01-25 13:45:00'),
      sysUpdatedOn: shiftDate('2026-01-25 16:45:00'),
      sysCreatedBy: 'system',
    ...
    },
    {
      ...
      openedAt: shiftDate('2026-02-01 14:30:00'),
      sysCreatedOn: shiftDate('2026-02-01 14:30:00'),
      sysUpdatedOn: new Date(),
      sysCreatedBy: 'system',
    ...
    },
    {
      ...
      openedAt: shiftDate('2026-01-29 08:00:00'),
      resolvedAt: shiftDate('2026-01-29 09:45:00'),
      closedAt: shiftDate('2026-01-29 10:00:00'),
      resolutionCode: 'Software Update',
      resolutionNotes: 'VPN concentrator firmware updated.',
      sysCreatedOn: shiftDate('2026-01-29 08:00:00'),
      sysUpdatedOn: shiftDate('2026-01-29 10:00:00'),
      sysCreatedBy: 'system',
    ...
    },
    {
      ...
      openedAt: shiftDate('2026-02-01 10:30:00'),
      resolvedAt: shiftDate('2026-02-01 11:15:00'),
      closedAt: shiftDate('2026-02-01 11:30:00'),
      resolutionCode: 'Service Restart',
      resolutionNotes: 'Print spooler service restarted. Queue cleared.',
      sysCreatedOn: shiftDate('2026-02-01 10:30:00'),
      sysUpdatedOn: shiftDate('2026-02-01 11:30:00'),
      sysCreatedBy: 'system',
    ...
    },
    {
      ...
      openedAt: shiftDate('2026-02-03 13:00:00'),
      sysCreatedOn: shiftDate('2026-02-03 13:00:00'),
      sysUpdatedOn: new Date(),
      sysCreatedBy: 'system',
      sysUpdatedBy: 'user_sn_002',
    },
    {
      ...
      openedAt: shiftDate('2026-02-02 08:45:00'),
      resolvedAt: shiftDate('2026-02-02 09:30:00'),
      closedAt: shiftDate('2026-02-02 09:45:00'),
      resolutionCode: 'Configuration Change',
      resolutionNotes: 'Active Directory group permissions updated.',
      sysCreatedOn: shiftDate('2026-02-02 08:45:00'),
      sysUpdatedOn: shiftDate('2026-02-02 09:45:00'),
      sysCreatedBy: 'system',
      sysUpdatedBy: 'user_sn_001',
    },
    {
      ...
      openedAt: shiftDate('2026-02-03 01:00:00'),
      sysCreatedOn: shiftDate('2026-02-03 01:00:00'),
      sysUpdatedOn: new Date(),
      sysCreatedBy: 'system',
      sysUpdatedBy: 'user_sn_003',
    },
    {
      ...
      openedAt: shiftDate('2026-01-31 14:00:00'),
      resolvedAt: shiftDate('2026-01-31 16:20:00'),
      closedAt: shiftDate('2026-01-31 16:30:00'),
      resolutionCode: 'Hardware Replacement',
      resolutionNotes: 'Faulty access point replaced.',
      sysCreatedOn: shiftDate('2026-01-31 14:00:00'),
      sysUpdatedOn: shiftDate('2026-01-31 16:30:00'),
      sysCreatedBy: 'system',
      sysUpdatedBy: 'user_sn_004',
    },
  ];
  ...
  const refinedIncidentsData = refinedServiceNowIncidents.map(incident => ({
    ...
    openedAt: shiftDate(incident.opened),
    updatedAt: shiftDate(incident.updated),
    resolvedAt: shiftDateNullable(incident.resolved),
    closedAt: shiftDateNullable(incident.closed),
